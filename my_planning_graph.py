...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        for action in self.all_actions:
            ...
            if actNode.prenodes.issubset(self.s_levels[level]):
                actNodes.append(actNode)
                for vertex in self.s_levels[level]:
                    vertex.children.add(actNode)
                    actNode.parents.add(vertex)

        self.a_levels.append(actNodes)
            #preconds and effects need to be connected through the action
